...
class ProductController extends Controller
{
    ...
    public function show(string $ProID)
    {
        ...
        return view('admin.product.detail', compact('product', 'ProID', 'CatID', 'ProName', 'ProDescription', 'ProColor', 'Metatitle', 'Materials', 'Size', 'ProImage', 'Tags', 'MoreImage', 'created_at', 'CreateBy', 'MetaDescriptions', 'Displayhome', 'Status', 'inventory', 'price', 'Discount', 'sold', 'quantity', 'updated_at'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $product = Product::where('ProName', 'LIKE', "%{$keyword}%")
            ->orWhere('Metatitle', 'LIKE', "%{$keyword}%")
            ->get();

        return view('admin.product.search', compact('product', 'keyword'));;
    }
}
