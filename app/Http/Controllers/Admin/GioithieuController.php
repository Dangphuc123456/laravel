...
class GioithieuController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $content_6 = $gt->content_6;
        $content_7 = $gt->content_7;
        $content_8 = $gt->content_8;
        $content_9 = $gt->content_9;
        $content_10 = $gt->content_10;
        $image = $gt->image;
    ...
    public function update(Request $request, String $id)
    {
        ...
        $gt->content_6 = $request->content_6;
        $gt->content_7 = $request->content_7;
        $gt->content_8 = $request->content_8;
        $gt->content_9 = $request->content_9;
        $gt->content_10 = $request->content_10;
