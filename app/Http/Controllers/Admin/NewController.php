...
class NewController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        return view('admin.new.detail', compact('tt', 'id','title','author','content_1','content_2','content_3','content_4','content_5','image_1','image_2','image_3','image_4','image_5','created_at','updated_at'));
    }
