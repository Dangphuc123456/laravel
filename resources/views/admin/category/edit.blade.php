...
<div class="box span12">
    <div class="box-header" data-original-title>
        <h2><i class="halflings-icon white user"></i><span class="break"></span>Sửa sản phẩm: {{$category->CatID}}</h2>
        <div class="box-icon">
    ...
    <div class="box-content">
        ...
        <form action="{{ route('category.update',['CatID' => $category->CatID])}}" method="post">
            @csrf
            @method('PUT')
