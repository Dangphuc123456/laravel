<div class="main_header">
        <div class="logo">
            <a><img style="width: 30px;height: 30px;" src="{{ asset('anh/user.png') }}" alt="Login Icon" id="loginIcon"></a> 
            @if(Auth::check())
                <span style="color:azure; margin-left: 10px;font-family: Arial, sans-serif;" id="usernameDisplay">{{ Auth::user()->username }}</span>
            @else
      ...
      <div class="giohang">
          <a href="{{route('gioHang')}}"><button type="button">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
